    ...
    InputArgs ia)
{
    ...
    r = elgamal_server_brute_force_thresholding(new_fd, server_keys, client_cipher, ia, num_entries);
    ...
    InputArgs ia)
{
    ...
    r = elgamal_client_brute_force_thresholding(sockfd, server_pk, exp_res, ia, num_entries);
